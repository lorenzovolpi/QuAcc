...
def parallel(func, args_list, n_jobs, seed=None, asarray=True, backend="loky", verbose=0, batch_size="auto"):
    """
    ...
    with ExitStack() as stack:
        ...
        out = Parallel(n_jobs=n_jobs, backend=backend, verbose=verbose, batch_size=batch_size)(
